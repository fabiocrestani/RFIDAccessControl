...
///////////////////////////////////////////////////////////////////////////////////////////////////
/// CheckPort.
/// Propósito: Verifica se a porta é válida<br>
...
///////////////////////////////////////////////////////////////////////////////////////////////////
/// Open.
/// Propósito: Abre uma porta serial<br>
/// Entradas: LPCTSTR lpszDevice<br>
/// Saídas: Código de erro se abriu ou não a porta<br>
///
/// \param lpszDevice
/// \param dwInQueue
/// \param dwOutQueue
...
///////////////////////////////////////////////////////////////////////////////////////////////////
/// Close.
/// Propósito: Fecha uma porta serial<br>
/// Entradas: Nenhuma<br>
/// Saídas: Código de erro se fechou ou não a porta<br>
///
///////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////
/// Setup.
/// Propósito: Configura os parâmetros da porta serial<br>
/// Entradas: EBaudrate eBaudrate, EDataBits eDataBits, EParity eParity, EStopBits eStopBits<br>
/// Saídas: Código de erro se fechou ou não a porta<br>
///
/// \param eBaudrate Baudrate da comunicação serial
/// \param eDataBits Bits de dados da comunicação serial
/// \param eParity Bits de paridade da comunicação serial
/// \param eStopBits Bits de stop da comunicação serial
///////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////
/// VerificaSeAbriu.
/// Propósito: Verifica o código de retorno da tentativa de abrir a porta e trata um possível erro
/// Entradas: O código de erro lLastError e o nome da porta nomePortaSerial
/// Saídas: Retorna true se abriu ou false caso contrário
///
/// \param [in] lLastError código do erro proveniente da abertura da porta
...
bool CSerial::VerificaSeAbriu(LONG lLastError, const TCHAR nomePortaSerial[]){
	...
	if(lLastError != ERROR_SUCCESS){
		cout << " Serial: Não foi possível abrir a porta ";
		printf("COM%c\n", nomePortaSerial[3]);
		system("pause");		
		return false;
	}
...
/// Propósito: Verifica o código de retorno da tentativa de configurar a porta e trata o erro
/// Entradas: O código de erro lLastError
/// Saídas: Retorna true se configurou ou false caso contrário
///
/// \param [in] lLastError código do erro proveniente da configuração da porta
///////////////////////////////////////////////////////////////////////////////////////////////////
bool CSerial::VerificaSeConfigurou(LONG lLastError){
	if (lLastError != ERROR_SUCCESS){
		cout << " Não foi possível configurar a porta COM5";
		system("pause");		
		return false;
	}
	return true;
...
/// Entradas: Nenhuma
/// Saídas: Apenas apresenta o status no console
///
///////////////////////////////////////////////////////////////////////////////////////////////////
