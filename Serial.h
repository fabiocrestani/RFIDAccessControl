///////////////////////////////////////////////////////////////////////////////////////////////////
///	\file Serial.h
/// \class CSerial Serial.h "Serial.h" Definition of the CSerial class.
///
///	Copyright (C) 1999-2003 Ramon de Klein (Ramon.de.Klein@ict.nl) <br>
/// <br>
...
#define ASCII_INTERROGACAO	  63				//< ASCII para '?'
#define ASCII_START_SERIAL	  58				//< ASCII para ':'
#define ASCII_STOP_SERIAL	  59				//< ASCII para ';'
#define	TAMANHO_MAXIMO_SERIAL 1					//< .
...
// Meus métodos -------------------------------------------------------------------------------------
public:
	bool VerificaSeAbriu(LONG lLastError, const TCHAR nomePortaSerial[]);
	bool VerificaSeConfigurou(LONG lLastError);
	void MostraConectado();
// --------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------
